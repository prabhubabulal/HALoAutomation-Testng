package automationTesting.haloAutomation.variables;

public class haloVariables {
	
	//Login Page
	
	public static String USERNAME = "//*[@id='txtUserame']";
	public static String PASSWORD = "//*[@id='txtPassword']";
	public static String DOMAIN = "//*[@id='ddlDomain']";
	public static String LOGINSUBMIT = "//*[@id='btnSubmit1']";
